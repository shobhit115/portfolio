...
import dawaiSaathiImg from '../assets/DawaiSaathi.png';
interface Project {
  title: string;
  category: string;
  description: string;
...
const Projects = () => {
  ...
  const projects: Project[] = [
    ...
    },
    {
      ...
      "description": "An AI-powered medicine information platform for the Indian public with explanations and audio output.",
      "longDescription": "Dawai Saathi is an AI-powered medicine information platform designed to make medicine understanding accessible to every Indian. Users can search or scan medicine strips to get simplified Hindi explanations powered by Google Gemini, with browser-based Text-to-Speech audio playback. Built with a 7,400+ Indian medicines dataset, fuzzy search via MongoDB Atlas, and OCR-based strip scanning — the platform aims to reduce misuse and unsafe self-medication across India.",
      "tech": [
        "React",
        "Node.js",
        "Express",
      ...
      "github": "https://github.com/shobhit115/DawaiSaathi",
      "demo": "https://dawaisaathi.vercel.app/",
      "image": dawaiSaathiImg,
      "year": 2025,
      "isFeatured": true
    },
    {
