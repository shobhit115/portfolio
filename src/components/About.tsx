...
const About = () => {
  ...
  {/* LeetCode */}
  <div className="bg-card/50 p-4 rounded-lg border border-orange-400/20 hover:border-orange-400/50 transition-colors">
    <div className="text-3xl font-orbitron font-bold text-orange-400">180+</div>
